...
function updateChart(emotions) {
    ...
    // Labels order: ['Happy', 'Sad', 'Angry', 'Fearful', 'Disgusted', 'Neutral']
    const labels = ['happy', 'sad', 'angry', 'fearful', 'disgusted', 'neutral'];
    ...
    updateTopEmotions(emotions);
}

function updateTopEmotions(emotions) {
    if (!topEmotionsList) return;
